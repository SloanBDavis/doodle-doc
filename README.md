...
`synth-build` now defaults to Nano Banana 2, `gemini-3.1-flash-image-preview`.
Pass `--model "<model id>"` if you want to override it.
Use `--no-clean` to append new synthetic pairs onto an existing dataset.
